...
# Genom '#coding=utf-8' talar jag om för Python 
# att jag vill inkludera teckenkodning på 8-bitar.
# "UTF-8" står för: 'Unicode Transformation Format – 8-bit'. 
# Mera angående 'utf-8' har jag skrivit om i medföljande .txt-fil [ angUTF-8.txt ].
# ––––––––––––––––––––––––––––––
...
pp = int('2')   # En "försöksräknare" som jag döpte till 'pp' för att den senare – på rad 43 – 
# kommer att bli "Plus-Plus" (++), dvs. att den inkrementerar / adderar 
# för varje nytt försök användaren gör! 
